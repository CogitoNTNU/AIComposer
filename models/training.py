...
def train(data_filepath, epochs=1, model_filename="model"):
    ...
    model = get_model(input_shape=(SEQUENCE_LENGTH, NUM_NOTES*3), output_shape=(NUM_NOTES*3))

    model.fit(gen, epochs=epochs, steps_per_epoch=10000, batch_size=BATCH_SIZE)
